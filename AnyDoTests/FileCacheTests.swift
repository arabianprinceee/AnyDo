...
class FileCacheTests: XCTestCase {
    ...
    func testAddTask() {
        ...
        fc.addTask(toDoItem: ToDoItemImplementation(id: "", text: "", importance: .standart, deadLine: nil))
        XCTAssertTrue(fc.toDoItems.count == 1)
    }
    
    func testDeleteTask() {
        fc.addTask(toDoItem: ToDoItemImplementation(id: "test_id", text: "", importance: .standart, deadLine: nil))
        XCTAssertTrue(fc.toDoItems.count == 1)
    ...
    func testSaveLoadAllTasks() {
        fc.addTask(toDoItem: ToDoItemImplementation(id: "test_id0", text: "", importance: .standart, deadLine: nil))
        fc.addTask(toDoItem: ToDoItemImplementation(id: "test_id1", text: "text1", importance: .important, deadLine: Date()))
